        ...
        <div className="footer-body">
          <div className="footer-content">
            <div className="footer-list">
              <h3 className="footer-list-header">About Fox Library</h3>
            ...
            <div className="footer-list">
              <h3 className="footer-list-header">Help</h3>
            ...
            <div className="footer-list">
              <h3 className="footer-list-header">My account</h3>
              <ul className="footer-list-account">
                <li className="footer-item">
